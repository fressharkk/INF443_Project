...
struct shadow_map_structure
{
	...
	void draw_shadow_map(cgp::hierarchy_mesh_drawable const& drawable, scene_environment_shadow_map const& scene);
	void draw_with_shadow(cgp::mesh_drawable const& drawable, scene_environment_shadow_map const& current_scene);
	void draw_with_shadow(cgp::hierarchy_mesh_drawable const& drawable, scene_environment_shadow_map const& current_scene);
};
