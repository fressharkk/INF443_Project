...
void Chevalier_Mesh::make_saddle()
{
	...
	saddle_bottom_ropes.texture = opengl_load_texture_image("assets/chevalier/saddle.jpg");
	saddle_head_ropes.initialize(mesh_load_file_obj("assets/French Horseman/cavalier_saddle_head_ropes.obj"), "Head Ropes Saddle");
	saddle_head_ropes.texture = opengl_load_texture_image("assets/chevalier/saddle.jpg");
...
void Chevalier_Mesh::make_horse()
{
	...
	horse_body_up.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	horse_body_left.initialize(mesh_load_file_obj("assets/French Horseman/cavalier_horse_remaining_body_left.obj"), "2");
	horse_body_left.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	...
	horse_body_right.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	back_right_leg.initialize(mesh_load_file_obj("assets/French Horseman/good_leg_back_2.obj"), "Back Right Leg");
	back_right_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	back_left_leg.initialize(mesh_load_file_obj("assets/French Horseman/cavalier_leg_back_left.obj"), "Back Left Leg");
	back_left_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	...
	front_right_middle_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	front_right_leg.initialize(mesh_load_file_obj("assets/French Horseman/good_leg_front.obj"), "Front Right Leg");
	front_right_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	...
	back_right_middle_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	front_left_leg.initialize(mesh_load_file_obj("assets/French Horseman/cavalier_leg_front_left.obj"), "Front Left Leg");
	front_left_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	...
	front_left_middle_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	back_left_middle_leg.initialize(mesh_load_file_obj("assets/French Horseman/middle_leg_final.obj"), "Back Left Middle Leg");
	back_left_middle_leg.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
	tail.initialize(mesh_load_file_obj("assets/French Horseman/cavalier_horse_tail.obj"), "Tail");
	tail.texture = opengl_load_texture_image("assets/chevalier/horse.jpg");
