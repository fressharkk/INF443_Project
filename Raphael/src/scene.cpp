...
void scene_structure::initialize()
{
	...
	mesh rock_mesh_1 = rock_with_texture(0.3f, {-4,0,0}, 8, 8);
	rock1.initialize(rock_mesh_1, "rock");
	rock_position = generate_positions_on_terrain(30, terrain_length);
	rock1.texture = opengl_load_texture_image("assets/rock_2.jpg", GL_CLAMP_TO_EDGE, GL_MIRRORED_REPEAT);

	mesh rock_mesh_2 = rock_with_texture_1(1, {-4,0,0}, 8, 8);
	rock2.initialize(rock_mesh_2, "rock");
	rock_position_2 = generate_positions_on_border(30, terrain_length);
	rock2.texture = opengl_load_texture_image("assets/rock_4.jpg", GL_CLAMP_TO_EDGE, GL_MIRRORED_REPEAT);

	mesh rock_mesh_3 = rock_with_texture_2(0.5f, {-4,0,0}, 8, 8);
	rock3.initialize(rock_mesh_3, "rock");
	rock_position_3 = generate_positions_on_border(30, terrain_length);
	rock3.texture = opengl_load_texture_image("assets/rock_3.jpg", GL_CLAMP_TO_EDGE, GL_MIRRORED_REPEAT);
	...
	mesh soldat_mesh = create_soldat_mesh();
	soldat.initialize(soldat_mesh, "soldat");
...
{	
	...
	draw(soldat, environment);
    chevalier->draw_chevalier(environment);
	...
	for (vec3 position : rock_position) {
		...
		z = z - 0.8f;
		vec3 position_2 = {x,y,z};
		rock1.transform.translation = position_2;
