...
float evaluate_terrain_height(float x, float y)
{
    ...
    float z = 0.0f;
    z = 68*std::exp(-(x-10)*(x-10)/(2*23))/ std::sqrt(2*3.14f*9*9)*std::exp(-(y)*(y)/(2*200)) + 36*std::exp(-(x-25)*(x-25)/(2*9))/ std::sqrt(2*3.14f*9*9) + 25*std::exp(-(x+28)*(x+28)/(2*9))/ std::sqrt(2*3.14f*9*9) + 36*std::exp(-(y-25)*(y-25)/(2*9))/ std::sqrt(2*3.14f*9*9)+ 36*std::exp(-(y+25)*(y+25)/(2*9))/ std::sqrt(2*3.14f*9*9);
...
std::vector<vec3> generate_positions_on_border(int N, float terrain_length)
{
    std::vector<cgp::vec3> position;
    for (int k = 0; k < N; ++k)
    {
